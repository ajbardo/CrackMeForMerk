...
class TestCase1(unittest.TestCase):
    ...
    def test_forMerkStateMachineClient_DH2(self):
        result = main.forMerkStateMachineClient(
            "DH_2:" + str(1 + main.private_value) + "," + str(2222 + main.private_value)).split("/")[0]
    ...
    def test_forMerkStateMachineServer_DH_1(self):
        ...
        self.assertEqual(result, "DH_1:" + str(main.forMERKGetPrivateValue() + main.common_value) + "/" + str(
            main.MERKgenTimeFlag()[0]))

    def test_forMerkStateMachineServer_DH_2(self):
        client_value = 1111
        result = main.forMerkStateMachineServer(
            "DH_2:" + str(client_value + main.forMERKGetPrivateValue()) + "/" + str(main.MERKgenTimeFlag()[0])).split(
            "/")[0]
